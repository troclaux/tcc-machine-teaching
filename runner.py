...
#problem_id = [816, 817, 819, 820, 821, 822]
#problem_id = [823, 824, 838, 839, 840, 842]
#problem_id = [742]
#criteria = ["input"]
#criteria = ["graph"]
criteria = ["mutation"]
...
#Parallel(n_jobs=6, verbose=5)(delayed(save_    tests_output)(i[0],i[1]) for i in executions)
end = time.time()
